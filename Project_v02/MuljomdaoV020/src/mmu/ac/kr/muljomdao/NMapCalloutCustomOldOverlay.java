...
public class NMapCalloutCustomOldOverlay extends NMapCalloutOverlay {
	...
	/**
	 * @uml.property  name="mTextPaint"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private final TextPaint mTextPaint = new TextPaint();
	/**
	 * @uml.property  name="mOffsetX"
	 */
	private float mOffsetX;
	/**
	 * @uml.property  name="mOffsetY"
	 */
	private float mOffsetY;

	/**
	 * @uml.property  name="mMarginX"
	 */
	private final float mMarginX;
	/**
	 * @uml.property  name="mPaddingX"
	 */
	private final float mPaddingX;
	/**
	 * @uml.property  name="mPaddingY"
	 */
	private final float mPaddingY;
	/**
	 * @uml.property  name="mPaddingOffset"
	 */
	private final float mPaddingOffset;
	/**
	 * @uml.property  name="mMinimumWidth"
	 */
	private final float mMinimumWidth;
	/**
	 * @uml.property  name="mTotalHeight"
	 */
	private final float mTotalHeight;
	/**
	 * @uml.property  name="mBackgroundHeight"
	 */
	private final float mBackgroundHeight;
	/**
	 * @uml.property  name="mItemGapY"
	 */
	private final float mItemGapY;
	/**
	 * @uml.property  name="mTailGapX"
	 */
	private final float mTailGapX;
	/**
	 * @uml.property  name="mTitleOffsetY"
	 */
	private final float mTitleOffsetY;

	/**
	 * @uml.property  name="mBackgroundDrawable"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private final Drawable mBackgroundDrawable;
	/**
	 * @uml.property  name="mTemp2Rect"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	protected final Rect mTemp2Rect = new Rect();
	/**
	 * @uml.property  name="mRightButtonRect"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private final Rect mRightButtonRect;
	/**
	 * @uml.property  name="mRightButtonText"
	 */
	private final String mRightButtonText;
	/**
	 * @uml.property  name="mCalloutRightButtonWidth"
	 */
	private final int mCalloutRightButtonWidth;
	/**
	 * @uml.property  name="mCalloutRightButtonHeight"
	 */
	private final int mCalloutRightButtonHeight;
	/**
	 * @uml.property  name="mDrawableRightButton"
	 * @uml.associationEnd  multiplicity="(0 -1)"
	 */
	private Drawable[] mDrawableRightButton;
	/**
	 * @uml.property  name="mCalloutButtonCount"
	 */
	private final int mCalloutButtonCount = 1;

	/**
	 * @uml.property  name="mTitleTruncated"
	 */
	private String mTitleTruncated;
	/**
	 * @uml.property  name="mWidthTitleTruncated"
	 */
	private int mWidthTitleTruncated;

	/**
	 * @uml.property  name="mTailText"
	 */
	private final String mTailText;
	/**
	 * @uml.property  name="mTailTextWidth"
	 */
