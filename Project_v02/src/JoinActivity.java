...
public class JoinActivity extends Activity implements OnClickListener{
	...
	/**
	 * @uml.property  name="login_id"
	 * @uml.associationEnd  
	 */
	EditText login_id;
	/**
	 * @uml.property  name="login_pw"
	 * @uml.associationEnd  
	 */
	EditText login_pw;
	/**
	 * @uml.property  name="login_repw"
	 * @uml.associationEnd  
	 */
	EditText login_repw;
	/**
	 * @uml.property  name="login_phone"
	 * @uml.associationEnd  
	 */
	EditText login_phone;
	/**
	 * @uml.property  name="login_age"
	 * @uml.associationEnd  
	 */
	EditText login_age;
	...
	public void onStop(){
		...
		EditText edit2 = (EditText)findViewById(R.id.Loginid);	// pw
